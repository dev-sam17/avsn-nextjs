...
export const metadata: Metadata = {
  title: "ANM Nursing Course - AV School of Nursing",
  description:
    "Pursue Auxiliary Nurse Midwifery (ANM) course with hands-on training at AV School of Nursing.",
  openGraph: {
    title: "ANM Nursing Course - AV School of Nursing",
    description:
      "Join the ANM program and kickstart your nursing career with practical training.",
    url: "https://www.avschoolofnursing.in/courses/anm",
  ...
  twitter: {
    ...
    title: "ANM Nursing Course - AV School of Nursing",
    description: "Apply for ANM course to begin your nursing profession.",
