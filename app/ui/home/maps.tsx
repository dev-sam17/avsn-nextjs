export const MapLocation = () => {
  return (
    <div className="bg-white w-[90%] mx-auto md:mx-5 my-5 md:w-[50%] h-[50vh] md:h-[35vh] lg:h-[35vh] xl:h-[50vh] p-4 border rounded-lg shadow-lg flex justify-center items-center">
      <iframe
